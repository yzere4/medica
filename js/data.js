const clinicData = {
    users: [
        { id: 'd1', role: 'doctor', username: 'd.nowak', password: 'haslo123', name: 'Dr. Anna Nowak', initials: 'AN', specialization: 'Kardiologia i choroby wewnętrzne', license: 'PL-18452', phone: '+48 600 111 222', email: 'anna.nowak@medica.pl', office: 'Gabinet 3A', shift: 'Pon-Śr 08:00-14:00', experience: '14 lat', focus: ['Nadciśnienie', 'Kardiologia zachowawcza', 'Profilaktyka'] },
        { id: 'd2', role: 'doctor', username: 'j.kowalski', password: 'haslo123', name: 'Dr. Jan Kowalski', initials: 'JK', specialization: 'Medycyna rodzinna', license: 'PL-20318', phone: '+48 600 333 444', email: 'jan.kowalski@medica.pl', office: 'Gabinet 2B', shift: 'Czw-Pt 10:00-18:00', experience: '11 lat', focus: ['Diabetologia', 'Medycyna pracy', 'Profilaktyka'] },
        { id: 'd3', role: 'doctor', username: 'p.wisniewski', password: 'haslo123', name: 'Dr. Piotr Wiśniewski', initials: 'PW', specialization: 'Pulmonologia i alergologia', license: 'PL-22671', phone: '+48 600 555 666', email: 'piotr.wisniewski@medica.pl', office: 'Gabinet 4C', shift: 'Pon-Pt 12:00-20:00', experience: '17 lat', focus: ['Astma', 'Alergie', 'Spirometria'] },
        ...
        { 
            ...
            bloodType: 'A+', insurance: 'NFZ + pakiet prywatny', emergencyContact: 'Maria Mickiewicz, +48 700 111 222', preferredLanguage: 'PL', riskLevel: 'Podwyższone', nextVisit: '2026-06-15 11:30', lastVisit: '2026-04-10 14:00', carePlan: 'Kontrola ciśnienia, dieta, monitorowanie glikemii', doctorPrimary: 'Dr. Anna Nowak', doctorSecondary: 'Dr. Jan Kowalski',
        ...
        { 
            ...
            bloodType: '0-', insurance: 'NFZ', emergencyContact: 'Elżbieta Słowacka, +48 700 222 333', preferredLanguage: 'PL', riskLevel: 'Umiarkowane', nextVisit: '2026-06-20 14:00', lastVisit: '2025-12-05 09:00', carePlan: 'Kontrola oddechowa i unikanie alergenów', doctorPrimary: 'Dr. Piotr Wiśniewski', doctorSecondary: 'Dr. Anna Nowak',
        ...
        { 
            ...
            bloodType: 'B+', insurance: 'NFZ', emergencyContact: 'Halina Prus, +48 700 333 444', preferredLanguage: 'PL', riskLevel: 'Niskie', nextVisit: '2026-07-10 08:30', lastVisit: '2026-05-18 10:15', carePlan: 'Profilaktyka roczna i badania przesiewowe', doctorPrimary: 'Dr. Jan Kowalski', doctorSecondary: 'Dr. Piotr Wiśniewski',
        ...
        { 
            ...
            bloodType: 'AB+', insurance: 'NFZ + opieka specjalistyczna', emergencyContact: 'Jadwiga Sienkiewicz, +48 700 444 555', preferredLanguage: 'PL', riskLevel: 'Wysokie', nextVisit: '2026-06-01 13:00', lastVisit: '2026-01-20 12:00', carePlan: 'Konsultacja kardiologiczna, kontrola leków, echo serca', doctorPrimary: 'Dr. Anna Nowak', doctorSecondary: 'Dr. Jan Kowalski',
        ...
        { 
            ...
            bloodType: 'A-', insurance: 'NFZ', emergencyContact: 'Zofia Reymont, +48 700 555 666', preferredLanguage: 'PL', riskLevel: 'Niskie', nextVisit: '2026-08-14 10:00', lastVisit: '2025-09-09 16:00', carePlan: 'Monitorowanie częstotliwości migren i farmakoterapia doraźna', doctorPrimary: 'Dr. Piotr Wiśniewski', doctorSecondary: 'Dr. Anna Nowak',
        ...
        { 
            ...
            bloodType: '0+', insurance: 'NFZ + ubezpieczenie dodatkowe', emergencyContact: 'Jan Orzeszko, +48 700 666 777', preferredLanguage: 'PL', riskLevel: 'Niskie', nextVisit: '2026-06-25 09:15', lastVisit: '2026-02-14 15:45', carePlan: 'Kontrola TSH i korekta dawki hormonów', doctorPrimary: 'Dr. Jan Kowalski', doctorSecondary: 'Dr. Piotr Wiśniewski',
        ...
        { 
            ...
            bloodType: 'B-', insurance: 'NFZ', emergencyContact: 'Stefan Konopnicki, +48 700 777 888', preferredLanguage: 'PL', riskLevel: 'Umiarkowane', nextVisit: '2026-07-05 11:30', lastVisit: '2026-04-01 11:00', carePlan: 'Odczulanie, testy alergiczne, kontrola objawów sezonowych', doctorPrimary: 'Dr. Anna Nowak', doctorSecondary: 'Dr. Jan Kowalski',
